...
╚════════════════════════════════════════════════════════╝"
    ...
    Spicetify       = "Spicetify detected, it must be installed after this CRACK, open recommended actions in FAQ ? [Y/N]"
    NoRestore       = "Cracked version has already been installed, xpui.bak not found. `nPlease uninstall Spotify client and run Install.bat again"
