[PSCustomObject]@{
    Welcome         = "
╔═══════════════════════════════════════════════════════════════════════════════╗
║ Bienvenido al Instalador de Spotify | Crackeado por Rootkit.SYS para Windows! ║
╚═══════════════════════════════════════════════════════════════════════════════╝"
    ...
    Spicetify       = "Spicetify detectado, debe ser instalado después de este CRACK, abrir acciones recomendadas en las preguntas frecuentes? [Y/N]"
    NoRestore       = "Esta versión crackeada ya ha sido instalada, xpui.bak no se encuentra. `nPor favor, desinstala el cliente de Spotify y ejecuta Install.bat de nuevo"
